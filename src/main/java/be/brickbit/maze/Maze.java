...
public class Maze {
    ...
    public int getValue(int yAxis, int xAxis) {
        return this.data[yAxis][xAxis];
    }

    public void markSpot(int xAxis, int yAxis)
    {
        if(this.data[xAxis][yAxis] == SPACE){
            this.data[xAxis][yAxis] = MARKER;
        }else{
